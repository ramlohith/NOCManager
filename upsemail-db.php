  ...
  <section id="container" class="">
   ...
   <!--sidebar end-->
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Email Service on Power Outrage</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>UPS Services</li>
						<li><i class="fa fa-file-text-o"></i>Email</li>
                                                <li><i class="icon_document_alt"></i> Database</li>
					</ol>
				</div>
			</div>
       	
        <h1 align = "center"> List of Clients</h1> <br /><br />
...
<td> <a href="deleteupsemail.php?varname=<?php echo $var ?> "> Click to Delete </a></td>
</tr>
<?php 
}
?>
</table>
     <p align="center"><a href="upsemail.php"> Return to Previous Page </a> </p
                          ...
                          <div class="panel-body">
                              <form class="form-inline" role="form" method = "post" action = "<?php $_PHP_SELF ?>">
                                  <div class="form-group">
                                      <label class="sr-only" for="Client-ID">Enter Client's ID</label>
...
$emp_id = $_POST['emp_id'];
$sql = "DELETE FROM Upsemail WHERE Upsemail.ID = $emp_id" ;
mysqli_select_db('Upsemail_db');
mysqli_query( $con, $sql );
$query = "SELECT * FROM Upsemail";
 $result = mysqli_query($con, $query);
 $num = mysqli_num_rows($result);
            
                       
 while($row= mysqli_fetch_array($result)){
            $output = $output . $row['Email'] . "\r\n";
            }
               
$myfile = fopen("upsemail.txt", "w");
