<!-- The Page that is displayed after User added to UPS Message service database -->
  <html>    
   <head>
...
//Connect to database
    ...
    $db = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
                ...
                $phone = $_POST['Phoneno'];
                $dept = $_POST['dept'];
                mysqli_query($db,"INSERT INTO Upsmessages(NAME,Phoneno,Department)
				VALUES('$Name','$phone','$dept')"); //Inserted into the Database UpsMessages in NOC

                $query = "SELECT * FROM Upsmessages";
                ...
                $myfile = fopen("phonenumbers.txt", "w");
...
<html>
  ...
  <section id="container" class="">
   ...
   <!--sidebar end-->
      ...
      <p align="center"><a href="upssms.php"> Return to Previous Page </a> </p>
