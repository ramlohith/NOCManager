 ...
 <html>    
   ...
   <?php
    ...
    $db = mysqli_connect(DB_SERVER,DB_USERNAME,DB_PASSWORD,DB_DATABASE);
                ...
                $email = $_POST['Email'];
                $dept = $_POST['dept'];
                mysqli_query($db,"INSERT INTO Serveremail(Name, Email ,Department)
				VALUES('$Name','$email','$dept')");

                $query = "SELECT * FROM Serveremail";
                ...
                $myfile = fopen("serveremail.txt", "w");
   ...
   <!--sidebar end-->
    ...
    <!--main content start-->
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> Email Service on Server Failure</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Server Services</li>
						<li><i class="fa fa-file-text-o"></i>Email</li>
                                                <li><i class="icon_document_alt"></i> Registeration</li>
					</ol>
				</div>
			</div>
      
      <h1 align = "center"> Your Deatils have been Saved! </h1> <br /><br />
      ...
      <p align="center"><a href="serveremail.php"> Return to Previous Page </a> </p>
