          ...
          <section class="wrapper">            
			  ...
			  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						<td><li><i class="fa fa-home"></i><a href="index1.php">Dashboard</a></li></td>
						<li><i class="icon_genius"></i><a href="upstatus.php">UPS Status</li>	
						<td><li><i class="fa fa-laptop"></i><a href="indexnew.php">website 
Status</a></li></td>					  	
					</ol>
				</div>
			</div>
      <center><object type="text/html" width="1000" height="600"  data="http://10.114.4.35/cgi-bin/apcupsd/multimon.cgi"> </center></object>	
	<center> <FORM>
