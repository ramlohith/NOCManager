...
$r = mysqli_query($db,"SELECT packet_loss FROM network WHERE network.ip='$var'");
...
if( $y == "100")
{
?> <font color = "red"> <b> <?php echo "SERVER DOWN!"; 
}?> </b> </font>
<?php 
if ( $y == "0")
{?> <font color= "green"> <b> <?php echo "SERVER ACTIVE"; } ?> </b> </font>
<?php
mysqli_close($db);
?>
<?php 
if ( $y > "0")
{?> <font color= "orange"> <b> <?php echo "PACKET LOSS OBSERVED"; } ?> </b> </font>
<?php
mysqli_close($db);
?>
...
<td>
<a target="_blank" class="btn btn-primary"  href="abc.php?varname=<?php echo $var ?> "> <i class="fa fa-signal"></i> </a> 
<a class="btn btn-danger"  href="deleteserver.php?varname1=<?php echo $i ?> "> <span class="glyphicon glyphicon-trash"></span>Delete Entry</a> 
</td>
</tr>
<?php
}
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Add Server to Monitor Status
                          </header>
                          <div class="panel-body">
                              <form action = "insertserver.php" class="form-horizontal " method="post">
                                  
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">IP Address of Server :</label>
                                      <div class="col-sm-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name ="serv_name" class="form-control" id="serv_name" type="text">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name = "loc" type="text" id = "loc" class="form-control" >
                                      </div>
                                  </div>
                                  <input name = "submit" value="Submit" type="submit" id="submit" onClick="return empty()">
