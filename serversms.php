                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form action = "sersmsadduser.php" class="form-horizontal " method="post">
                                  ...
                                  <input type="reset" value="Reset"> 
                                   <!--<td align="center"><a href="sersmsdb.php"> View contacts in database </a></td> -->
                                  <center><td align = "center"><a href="sersmsdb.php" class="btn btn-primary">
