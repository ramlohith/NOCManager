  ...
  <section id="container" class="">
   ...
   <!--sidebar end-->
      ...
      <section id="main-content">
		  ...
		  <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-file-text-o"></i> SMS Service on Server Failure</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
						<li><i class="icon_document_alt"></i>Server Services</li>
...
<td> <a href="deleteserversms.php?varname=<?php echo $var ?> "> Click to Delete </a></td>
</tr>
<?php 
}
?>
</table>
     <p align="center"><a href="serversms.php"> Return to Previous Page </a> </p
                          ...
                          <div class="panel-body">
                              <form class="form-inline" role="form" method = "post" action = "<?php $_PHP_SELF ?>">
                                  <div class="form-group">
                                      <label class="sr-only" for="Client ID">Enter Client ID</label>
...
$sql = "DELETE FROM Serversms WHERE Serversms.ID = $emp_id" ;
mysqli_select_db('Serversms_db');
mysqli_query($con, $sql);
 $query = "SELECT * FROM Serversms";
...
$myfile = fopen("serverphonenumbers.txt", "w");
