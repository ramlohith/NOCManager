                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                             Add Client to Email Service
                          </header>
                          <div class="panel-body">
                              <form action = "serveremailadduser.php" class="form-horizontal " method="post">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input name ="Email" class="form-control" id="focusedInput" type="text">
                                      </div>
                                  </div>
                                  ...
                                  <!-- <td align="center"><a href="serveremail-db.php"> View contacts in database </a></td> -->
                                    <center><td align = "center"><a href="serveremail-db.php" class="btn btn-primary">
