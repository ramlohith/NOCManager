                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form action = "upsemailadduser.php" class="form-horizontal " method="post">
                                  ...
                                  <input type="reset" value="Reset"> 
                                   <!--<td align="center"><a href="upsemail-db.php"> View contacts in database </a></td> -->
                                   <center><td align = "center"><a href="upsemail-db.php" class="btn btn-primary">
